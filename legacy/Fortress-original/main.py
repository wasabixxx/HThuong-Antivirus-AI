...
def CloseWindow(event):
    ...
    ioIconImange = PIL.Image.open("C:\\Users\\Chiranjeev\\The CV\\Code Playground\\College Projects Repo\\Cyber Project 4th Sem\\Bit-Link Antivirus Pro Working\\res\\Logo")
