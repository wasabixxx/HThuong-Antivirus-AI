...
import { Globe, Search, ShieldAlert, ShieldCheck, ExternalLink, Loader2 } from 'lucide-react';
...
export default function UrlScan() {
  ...
  return (
    <div>
      ...
      <p className="text-gray-400 mb-8">Check URL for phishing, malware, and other threats using VirusTotal</p>
      ...
      <form onSubmit={handleScan} className="flex gap-3 mb-6">
        <div className="flex-1 relative">
          ...
          <input
            ...
            placeholder="https://example.com or suspicious-site.xyz"
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className={`text-2xl font-bold ${result.detected ? 'text-red-400' : 'text-emerald-400'}`}>
                  {result.detected ? '⚠️ DANGEROUS URL' : '✅ URL is Safe'}
                </h2>
          ...
          {result.stats && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <h3 className="text-sm font-semibold text-gray-400 uppercase mb-3">VirusTotal Analysis</h3>
              ...
              {result.vt_link && (
                <a href={result.vt_link} target="_blank" rel="noopener noreferrer"
                  ...
                  View full report on VirusTotal <ExternalLink className="w-3 h-3" />
                </a>
              )}
            </div>
          )}
